...
class _SupportPageState extends State<SupportPage> {
  ...
  void initState() {
    ...
    if (widget.orderId != null) {
      _orderController.text = widget.orderId!;
    }
  }
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.headset_mic, color: Color(0xFF6366F1)),
                        ),
                    ...
                    Text(
                      'Tell us more about your issue. Our support team will reach out shortly.',
                      style: GoogleFonts.plusJakartaSans(
