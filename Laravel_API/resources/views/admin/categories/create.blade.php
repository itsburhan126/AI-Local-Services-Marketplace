...
<div class="content-transition">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800 font-jakarta">Add Category</h1>
            <p class="text-gray-500 mt-1">Create a new service category</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="type" id="category-type" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-all bg-white/50">
                        <option value="local_service" {{ old('type', 'local_service') === 'local_service' ? 'selected' : '' }}>Local Service</option>
                ...
                <div class="space-y-2">
                    ...
                    <select name="parent_id" id="parent-category" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-all bg-white/50">
