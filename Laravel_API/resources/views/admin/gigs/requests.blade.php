                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                @if(!empty($gig->thumbnail_image))
                                    ...
                                    @endphp
                                    <img src="{{ $thumbnailUrl }}" class="w-12 h-12 rounded-lg object-cover shadow-sm" alt="Gig">
                                @elseif(!empty($gig->images) && count($gig->images) > 0)
                                    ...
                                    @endphp
                                    <img src="{{ $imageUrl }}" class="w-12 h-12 rounded-lg object-cover shadow-sm" alt="Gig">
                                @else
