...
<head>
    ...
    <title>Login - {{ config('app.name', 'AI Local Services Marketplace') }}</title>
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-brand-900 relative overflow-hidden flex-col justify-between p-12 text-white">
        ...
        <div class="relative z-10 max-w-lg">
            <h1 class="text-5xl font-bold leading-tight mb-6 animate-slide-up">
                Welcome back to your <span class="text-brand-300">workspace.</span>
            </h1>
            <p class="text-lg text-brand-100 mb-8 leading-relaxed animate-slide-up" style="animation-delay: 0.1s">
                Pick up where you left off. Manage your gigs, chat with clients, and track your earnings all in one place.
            </p>
            
            <!-- Stats -->
            <div class="grid grid-cols-2 gap-6 animate-slide-up" style="animation-delay: 0.2s">
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                    <div class="text-3xl font-bold text-white mb-1">2.4k+</div>
                    <div class="text-brand-200 text-sm">Active Jobs</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                    <div class="text-3xl font-bold text-white mb-1">$4M+</div>
                    <div class="text-brand-200 text-sm">Paid to Freelancers</div>
                </div>
            </div>
        </div>
        ...
        <div class="relative z-10 animate-slide-up" style="animation-delay: 0.3s">
            <div class="flex items-center space-x-4 bg-white/10 p-4 rounded-2xl backdrop-blur-sm border border-white/10">
                <img src="https://ui-avatars.com/api/?name=David+Kim&background=random" class="w-12 h-12 rounded-full border-2 border-brand-300" alt="User">
                <div>
                    <p class="text-sm text-white italic">"Managing my freelance business has never been easier. The dashboard is intuitive and powerful."</p>
                    <p class="text-xs text-brand-200 mt-1 font-semibold">David Kim, Web Developer</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-md w-full animate-fade-in">
            <div class="text-center mb-10">
                ...
                <p class="mt-2 text-gray-500">
                    Log in to your <span class="text-brand-600 font-semibold">Freelancer</span> account.
                </p>
            </div>
            ...
            <div class="relative my-8">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-4 bg-white text-gray-500 font-medium">Or login with email</span>
                </div>
            </div>

            <form action="{{ route('provider.freelancer.login.submit') }}" method="POST" class="space-y-5">
                @csrf
                <!-- Email -->
                <div>
                ...
                <div>
                    ...
                    <input type="password" id="password" name="password" required class="block w-full px-4 py-3 rounded-xl border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-brand-500 focus:ring-brand-500 transition-all duration-200 placeholder-gray-400" placeholder="••••••••">
                </div>

                <!-- Remember Me & Forgot Password -->
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 text-brand-600 focus:ring-brand-500 border-gray-300 rounded transition-colors">
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('provider.freelancer.register') }}" class="font-semibold text-brand-600 hover:text-brand-500 transition-colors">
                        Sign up
                    </a>
                </p>
            </div>
