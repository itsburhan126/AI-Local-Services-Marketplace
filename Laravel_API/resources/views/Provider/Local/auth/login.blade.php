    ...
    <div class="hidden lg:flex lg:w-1/2 bg-brand-900 relative overflow-hidden flex-col justify-between p-12 text-white">
        ...
        <div class="relative z-10 max-w-lg">
            ...
            <p class="text-lg text-brand-100 mb-8 leading-relaxed animate-slide-up" style="animation-delay: 0.1s">
                Manage your service bookings, coordinate with customers, and grow your local business.
            </p>
            ...
            <div class="grid grid-cols-2 gap-6 animate-slide-up" style="animation-delay: 0.2s">
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                    ...
                    <div class="text-brand-200 text-sm">Jobs Today</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                    <div class="text-3xl font-bold text-white mb-1">$2M+</div>
                    <div class="text-brand-200 text-sm">Provider Earnings</div>
                </div>
            </div>
        </div>
        ...
        <div class="relative z-10 animate-slide-up" style="animation-delay: 0.3s">
            <div class="flex items-center space-x-4 bg-white/10 p-4 rounded-2xl backdrop-blur-sm border border-white/10">
                <img src="https://ui-avatars.com/api/?name=John+Doe&background=random" class="w-12 h-12 rounded-full border-2 border-brand-300" alt="User">
                <div>
                    <p class="text-sm text-white italic">"My plumbing business doubled in revenue within 3 months. The local leads are high quality."</p>
                    <p class="text-xs text-brand-200 mt-1 font-semibold">John Doe, Professional Plumber</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-md w-full animate-fade-in">
            <div class="text-center mb-10">
                ...
                <p class="mt-2 text-gray-500">
                    Log in to your <span class="text-brand-600 font-semibold">Local Provider</span> account.
                </p>
            </div>
            ...
            <form action="{{ route('provider.local.login.submit') }}" method="POST" class="space-y-5">
                @csrf
                <!-- Email -->
                <div>
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('provider.local.register') }}" class="font-semibold text-brand-600 hover:text-brand-500 transition-colors">
                        Sign up
                    </a>
                </p>
            </div>
