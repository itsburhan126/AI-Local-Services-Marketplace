    ...
    <div class="hidden lg:flex lg:w-1/2 bg-brand-900 relative overflow-hidden flex-col justify-between p-12 text-white">
        ...
        <div class="relative z-10 max-w-lg">
            <h1 class="text-5xl font-bold leading-tight mb-6 animate-slide-up">
                Grow your local <span class="text-brand-300">business.</span>
            </h1>
            <p class="text-lg text-brand-100 mb-8 leading-relaxed animate-slide-up" style="animation-delay: 0.1s">
                Join thousands of local service providers connecting with customers in your area. 
                Experience instant bookings, secure payments, and tools to manage your team.
            </p>
            ...
            <ul class="space-y-4 animate-slide-up" style="animation-delay: 0.2s">
                <li class="flex items-center space-x-3 text-brand-50">
                    ...
                    <span>0% Commission on first 5 bookings</span>
                </li>
                <li class="flex items-center space-x-3 text-brand-50">
                    <svg class="w-5 h-5 text-brand-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
        ...
        <div class="max-w-md w-full animate-fade-in">
            <div class="text-center mb-10">
                ...
                <p class="mt-2 text-gray-500">
                    Sign up as a <span class="text-brand-600 font-semibold">Local Provider</span> to get started.
                </p>
            </div>
            ...
            <form action="{{ route('provider.local.register.submit') }}" method="POST" class="space-y-5">
                @csrf
                <!-- Name -->
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Company / Full Name</label>
                    <input type="text" id="name" name="name" required class="block w-full px-4 py-3 rounded-xl border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-brand-500 focus:ring-brand-500 transition-all duration-200 placeholder-gray-400" placeholder="e.g. John's Plumbing">
                </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('provider.local.login') }}" class="font-semibold text-brand-600 hover:text-brand-500 transition-colors">
                        Log in
                    </a>
                </p>
