        ...
        <div class="w-full lg:w-1/2 flex flex-col">
            ...
            <div class="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-24 py-12">
                <div class="w-full max-w-md mx-auto">
                    ...
                    <!-- Google Button -->
                    <button type="button" onclick="toastr.info('Google Login coming soon!', 'Info')" class="w-full flex items-center justify-center px-4 py-3 border border-gray-200 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors mb-8">
                    ...
                    <div class="mt-8 text-center text-sm text-slate-600">
                        Already have an account? <a href="{{ route('customer.login') }}" class="font-bold text-indigo-600 hover:text-indigo-700 transition-colors">Log in</a>
                    </div>
